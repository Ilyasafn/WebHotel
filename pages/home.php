   ...
   <section class="row">
        <div class="col-8">
            ...
            <!-- ABOUT HOTEL -->
            <p>LeafIn Hotel Balikpapan is a luxurious property conveniently located near the centre of Balikpapan City.</p>
            <p>
            <b>Facilities</b>
            <br>
            ...
            <b>Transportation/Parking facilities</b>
            <br>
            <p>LeafIn Hotel Balikpapan offers transportation to/from the airport. Limo/Town car services can be arranged.</p>
            <!-- ABOUT HOTEL END -->

            <hr>

            <!-- FASILITAS HOTEL -->
            <h3>LeafIn Hotel Balikpapan Services and Facilities</h3>
        ...
        <div class="col">
            ...
            <div class="card bg-warning">
                <div class="card-body">
                    ...
                    </svg><p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                </div>
            </div>
